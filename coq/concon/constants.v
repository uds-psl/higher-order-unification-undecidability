Require Import List Omega Morphisms Setoid std calculus.
Require Import
        higher_order_unification nth_order_unification
        conservativity.
...
Program Instance RE_abg_gonly : retract gonly abg :=
  {|
    I := fun _ => None;
...
Lemma Goldfarb_remove:
  H10 ⪯ OU 2 abg /\ OU 2 abg ⪯ OU 2 gonly.
Proof.
  split. eapply Goldfarb.
  eapply (@remove_constants_reduction abg gonly); eauto.
  intros [[]|]; cbn; eauto.
  intros [[[[]|]|]|]; cbn; eauto.
